...
class MDNGovInternationalEntertainmentSpider(scrapy.Spider):
    name = "mdngov_international_entertainment"
    allowed_domains = ["mdn.gov.mm"]
    start_urls = ["https://www.mdn.gov.mm/my/international-entertainment"]
                ...
                if sentences:
                    for i in range(0, len(sentences)):
                        ...
                        if len(chunk) >= self.MAX_LENGTH:
                            ...
                            item["text"] = chunk
                            item["category"] = "International Entertainment"
